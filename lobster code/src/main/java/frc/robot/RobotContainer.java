...
// 
    ...
    private void name_commands() {
        ...
        NamedCommands.registerCommand("ScoreCoral1",eleclaw.score_coral_1());//just position no score
        NamedCommands.registerCommand("PickCoral", intake.intake_coral_command());
        NamedCommands.registerCommand("ScoreCoral4", intake.auto_outtake_coral_command()); // WIP (lowk have no idea what im doing here) attempt at making level 4 coral score autonomous
